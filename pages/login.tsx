  ...
  return (
    <div className="flex justify-center items-center">
      <div>
        ...
        <h1 className="text-center font-bold text-xl mt-10">로그인</h1>
        <div className="w-[500px] h-96 bg-slate-300 mt-10 rounded-xl flex flex-col justify-center items-center">
          <form
          ...
          <button
            ...
            className="bg-blue-500 rounded-md w-3/5 py-2 mb-9 text-white shadow-sm hover:bg-blue-600 outline-none self-center"
          >
            회원가입
          </button>
        </div>
